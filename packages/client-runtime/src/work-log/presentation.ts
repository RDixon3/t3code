...
> = {
  ...
  create_threads: ["Create", "Creating", "Created", "CoCo threads"],
  t3_thread_start: ["Start", "Starting", "Started", "a CoCo thread"],
  t3_thread_list: ["List", "Listing", "Listed", "CoCo threads"],
  t3_thread_read: ["Read", "Reading", "Read", "a CoCo thread"],
  t3_thread_send: ["Send", "Sending", "Sent", "to a CoCo thread"],
  t3_thread_wait: ["Wait", "Waiting", "Waited", "for a CoCo thread"],
  t3_thread_interrupt: ["Interrupt", "Interrupting", "Interrupted", "a CoCo thread"],
