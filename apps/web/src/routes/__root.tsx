...
import { ServiceNowSdkUpdateNotification } from "../components/ServiceNowSdkUpdateNotification";
    ...
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        >
          ...
          {primaryEnvironmentAuthenticated ? <ServiceNowSdkUpdateNotification /> : null}
          {appShell}
