...
export const V0_AGENT_TOOLS_CHANNEL = "desktop:v0-agent-tools";
export const V0_AGENT_CALL_CHANNEL = "desktop:v0-agent-call";
export const V0_STATUS_CHANNEL = "desktop:v0-status";
export const V0_CONNECT_CHANNEL = "desktop:v0-connect";
export const V0_TEST_CHANNEL = "desktop:v0-test";
export const V0_CANCEL_CHANNEL = "desktop:v0-cancel";
export const V0_DISCONNECT_CHANNEL = "desktop:v0-disconnect";
export const V0_CHANGED_CHANNEL = "desktop:v0-changed";
...
export const SERVICENOW_TEST_CHANNEL = "desktop:servicenow-test";
export const SERVICENOW_DISCONNECT_CHANNEL = "desktop:servicenow-disconnect";
...
export const CHECK_SERVICENOW_SDK_UPDATES_CHANNEL = "desktop:check-servicenow-sdk-updates";
export const UPDATE_SERVICENOW_SDK_CHANNEL = "desktop:update-servicenow-sdk";
