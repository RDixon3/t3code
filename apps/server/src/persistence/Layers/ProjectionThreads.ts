...
import { CoCoAgent, ModelSelection, ThreadLinkedPullRequest } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.cocoAgent ? JSON.stringify(row.cocoAgent) : null},
          ${row.runtimeMode},
          ${row.interactionMode},
          ${row.branch},
          ${row.worktreePath},
        ...
        DO UPDATE SET
          ...
          coco_agent_json = excluded.coco_agent_json,
